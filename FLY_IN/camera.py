...
Args:
    screen: Surface d'affichage fournie pour compatibilité
    avec l'appelant. Elle
...
La position de la caméra est soustraite du point,
puis le résultat est multiplié
...
Args:
    zoom: Nouveau facteur de zoom. La validation des limites,
    si nécessaire, est
