...
La classe attend que la première directive soit ``nb_drones`` et garantit qu'elle
...
La première ligne doit obligatoirement déclarer ``nb_drones`` et cette directive
